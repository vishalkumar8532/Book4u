  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_product_modal" class="btn btn-primary btn-sm">Add book</a>
      	</div>
      </div>
        	...
        	<div class="row">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<textarea class="form-control" name="product_desc" placeholder="Enter Book desc"></textarea>
		        	</div>
        		</div>
            <div class="col-12">
              <div class="form-group">
                <label>Book Qty</label>
                <input type="number" name="product_qty" class="form-control" placeholder="Enter Book Quantity">
              </div>
            </div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Book Price</label>
		        		<input type="number" name="product_price" class="form-control" placeholder="Enter Book Price">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Author Name</label>
		        		<input type="text" name="product_keywords" class="form-control" placeholder="Author Name">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
